...
contract('LongevityCrowdsale', function (accounts) {
  ...
  it('Set phase 0x0 to 1520000000, 1539999999, 40', function () {
    return LongevityCrowdsale.deployed().then(function (instance) {
      return instance.addPhase(1520000000, 1539999999, 40);
    }).then(function (result) {
      assert.equal(result['logs'][0]['event'], 'PhaseAdded');
    });
  });
  it('Check phase 0x0 value is 40', function () {
    return LongevityCrowdsale.deployed().then(function (instance) {
      return instance.getDiscountPercent(1520000000);
    }).then(function (result) {
  ...
  it('Delete phase 0x0', function () {
    return LongevityCrowdsale.deployed().then(function (instance) {
      ...
      assert.equal(result['logs'][0]['event'], 'PhaseDeleted');
    });
  });
  it('Set phase 0x0 to 1520000000, 1539999999, 40', function () {
    return LongevityCrowdsale.deployed().then(function (instance) {
  ...
  it('Add phase 0x1 to 1540000000, 1553000000, 30', function () {
    return LongevityCrowdsale.deployed().then(function (instance) {
      return instance.addPhase(1540000000, 1553000000, 30);
    }).then(function (result) {
      assert.equal(result['logs'][0]['event'], 'PhaseAdded');
    });
  });
  it('Check phase 0x1 value is 30', function () {
    return LongevityCrowdsale.deployed().then(function (instance) {
      return instance.getDiscountPercent(1540000000);
    }).then(function (result) {
  ...
  it('calculateUSDcValue with view function for 0.23561 Ether', function () {
    return LongevityCrowdsale.deployed().then(function (instance) {
      return instance.calculateUSDcValue(0.2356 * 1e18);
    }).then(function (result) {
      assert.equal(result, 30769);
    });
  });
  it('calculateTokenAmount with view function for 0.2356 Ether (with discount)', function () {
    return LongevityCrowdsale.deployed().then(function (instance) {
      return instance.calculateTokenAmount(0.2356 * 1e18, 45);
    }).then(function (result) {
      assert.equal(result, 5569189);
    });
  });
  ...
  it('USD raised changed after payment receive', function () {
    return LongevityCrowdsale.deployed().then(function (instance) {
      ...
      assert.equal(result.toString(), 9999);
    });
  });
